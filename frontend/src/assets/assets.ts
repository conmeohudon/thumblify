            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a target="_blank" href="https://www.youtube.com/@kiennguyenthe1083" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.ibb.co/r2MVyrzH/IMG-2301.jpg" class="rounded-full size-7" /> Con Mèo Hư Đốn </a>
                ...
                <main class="lg:ml-60 w-full px-6 py-6">
                    ...
                    <!-- VIDEO GRID -->
                    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 cursor-pointer">
                        <!-- CARD -->
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">How to play tft?</h3>
                                    <p class="text-sm text-gray-400">Nam de</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">How to get 5 cost 3 stars</h3>
                                    <p class="text-sm text-gray-400">Đức đụt</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Oh Fuoc</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Kien dz Channel</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">How can I code until 4 AM and still wake up at 7 AM for work?</h3>
                                    <p class="text-sm text-gray-400">Diễm dê</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Thắng đắng cay</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">How to masturbate 10 times a day?</h3>
                                    <p class="text-sm text-gray-400">Vân sờ veo</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">First date in my life</h3>
                                    <p class="text-sm text-gray-400">Hồng tỷ</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    <h3 class="font-semibold line-clamp-2">FULL VERSION | Tái sinh làm lại cuộc đời, tôi bù đắp cho vợ yêu | Con Mèo Hư Đốn Vietsub</h3>
                                    <p class="text-sm text-gray-400">Con Mèo Hư Đốn</p>
                                    <p class="text-sm text-gray-400">1.1M views • 3 days ago</p>
                                </div>
                            </div>
                        </article>
